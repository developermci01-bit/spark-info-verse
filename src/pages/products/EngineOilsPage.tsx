...
import heroImg from '@/assets/products/engine-hero.jpg';
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative animate-fade-in">
                ...
                <img src={heroImg} alt="Premium engine oil" width={1280} height={960} className="relative rounded-2xl border border-border shadow-2xl w-full h-auto max-h-[400px] object-cover" />
              </div>
            </div>
          </div>
        </section>
