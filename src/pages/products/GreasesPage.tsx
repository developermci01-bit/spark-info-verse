...
import heroImg from '@/assets/products/grease-hero.png';
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative animate-fade-in">
                ...
                <img src={heroImg} alt="Industrial greases" width={1280} height={960} loading="eager" fetchPriority="high" decoding="async" sizes="(min-width: 1024px) 50vw, 100vw" className="relative rounded-2xl border border-border shadow-2xl w-full h-auto max-h-[400px] object-cover" />
              </div>
            </div>
          </div>
        </section>
