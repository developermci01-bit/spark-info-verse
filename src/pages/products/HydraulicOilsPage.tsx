...
import heroAsset from '@/assets/products/hydraulic-hero.png.asset.json';
const heroImg = heroAsset.url;
import img1 from '@/assets/products/hydraulic-1.jpg';
import img2 from '@/assets/products/hydraulic-2.jpg';
import img3 from '@/assets/products/hydraulic-3.jpg';
...
const HydraulicOilsPage = () => {
  ...
  const gallery = [
    { src: img1, caption: 'Industrial Presses' },
    { src: img2, caption: 'Construction Machinery' },
    { src: img3, caption: 'Hydraulic Systems' },
  ];

  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Hydraulic Oils — Industrial & Construction Machinery"
        description="High-efficiency hydraulic oils for presses, construction machinery and hydraulic systems. Reliable pump, valve and cylinder protection."
        path="/products/hydraulic-oils"
      />
      <Header />
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="font-heading text-2xl lg:text-3xl font-bold text-foreground">Built for Demanding Applications</h2>
            </div>
            <div className="grid md:grid-cols-3 gap-6">
              {gallery.map((g, i) => (
