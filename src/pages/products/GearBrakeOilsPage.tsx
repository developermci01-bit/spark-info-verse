          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative animate-fade-in">
                ...
                <img src={heroImg} alt="Gear and brake oils" width={1280} height={960} className="relative rounded-2xl border border-border shadow-2xl w-full h-auto object-cover" />
              </div>
            </div>
          </div>
        </section>
