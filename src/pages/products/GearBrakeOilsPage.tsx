...
import { Settings, Shield, Gauge } from 'lucide-react';
import heroAsset from '@/assets/products/gear-hero.png.asset.json';
const heroImg = heroAsset.url;
import img1 from '@/assets/products/gear-1.jpg';
import img2 from '@/assets/products/gear-2.jpg';
import img3 from '@/assets/products/gear-3.jpg';
...
const GearBrakeOilsPage = () => {
  ...
  const gallery = [
    { src: img1, caption: 'Manual Transmissions' },
    { src: img2, caption: 'Brake Systems' },
    { src: img3, caption: 'Differentials' },
  ];

  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Gear & Brake Oils — Smooth Shifts, Safe Stops"
        description="Premium gear oils and brake fluids for manual transmissions, differentials and braking systems. Pressure-resistant and long-lasting."
        path="/products/gear-brake-oils"
      />
      <Header />
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative animate-fade-in">
                ...
                <img src={heroImg} alt="Gear and brake oils" width={1280} height={960} loading="eager" fetchPriority="high" decoding="async" sizes="(min-width: 1024px) 50vw, 100vw" className="relative rounded-2xl border border-border shadow-2xl w-full h-auto max-h-[400px] object-cover" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="font-heading text-2xl lg:text-3xl font-bold text-foreground">Where Precision Matters</h2>
            </div>
            <div className="grid md:grid-cols-3 gap-6">
              {gallery.map((g, i) => (
